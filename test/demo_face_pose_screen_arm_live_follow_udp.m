function demo_face_pose_screen_arm_live_follow_udp(workspaceMode, startFaceModule)
%DEMO_FACE_POSE_SCREEN_ARM_LIVE_FOLLOW_UDP UDP face-pose driven arm demo.
%
% Usage:
%   demo_face_pose_screen_arm_live_follow_udp
%   demo_face_pose_screen_arm_live_follow_udp("normal")
%   demo_face_pose_screen_arm_live_follow_udp("normal", false)  % no camera process
...
fig = figure( ...
    "Name", "Live Face Pose Screen Arm Follow UDP", ...
    "NumberTitle", "off", ...
    "Color", "w", ...
    "MenuBar", "none", ...
    "ToolBar", "figure", ...
...
pythonLogFile = fullfile(tempdir, "screen_arm_face_pose_live_udp.log");
...
try
    pose = jsondecode(char(latestText));
catch decodeError
